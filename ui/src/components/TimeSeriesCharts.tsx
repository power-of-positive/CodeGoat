...
function processRunsData(runs: ValidationRun[]): ChartDataPoint[] {
...
function renderSuccessRateChart(chartData: ChartDataPoint[]): React.JSX.Element {
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-gray-900">Success Rate Over Time</CardTitle>
...
function renderDurationChart(chartData: ChartDataPoint[]): React.JSX.Element {
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-gray-900">Average Duration Over Time</CardTitle>
...
export function TimeSeriesCharts({ runs }: TimeSeriesChartsProps): React.JSX.Element {
  const chartData = useMemo(() => processRunsData(runs), [runs]);
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      {renderSuccessRateChart(chartData)}
