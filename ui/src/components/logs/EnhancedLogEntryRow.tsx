...
import { UnifiedLogEntry, ProcessStartPayload } from '../../types/logs';
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          ...
          <div className="text-xs text-gray-600 dark:text-gray-400 mt-1">
            ...
            <span className="ml-4">Started: {new Date(payload.startedAt).toLocaleString()}</span>
          </div>
        </div>
      </div>
    </div>
...
const StdoutEntry: React.FC<{ content: string }> = ({ content }) => (
  <div className="font-mono text-sm text-green-700 dark:text-gray-100 bg-gray-50 dark:bg-gray-900 px-2 py-1 rounded border-l-2 border-green-500">
    {content}
  </div>
);

const StderrEntry: React.FC<{ content: string }> = ({ content }) => (
  <div className="font-mono text-sm text-red-700 dark:text-red-300 bg-red-50 dark:bg-red-950/20 px-2 py-1 rounded border-l-2 border-red-500">
    {content}
  </div>
);
...
export default memo(EnhancedLogEntryRow, (prevProps, nextProps) => {
