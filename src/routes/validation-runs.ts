...
import {
  GetAllValidationRunsQuerySchema,
  GetSingleValidationRunParamsSchema,
  CreateValidationRunRequestSchema,
  GetAnalyticsSummaryQuerySchema,
  GetStageAnalyticsQuerySchema,
...
export function createValidationRunRoutes(logger: WinstonLogger) {
  ...
  router.get(
    '/',
    validateQuery(GetAllValidationRunsQuerySchema),
  ...
  router.get(
    '/:id',
    validateParams(GetSingleValidationRunParamsSchema),
    async (req: Request, res: Response) => {
      try {
        const db = getDatabaseService();
  ...
  router.get(
    '/analytics/summary',
    validateQuery(GetAnalyticsSummaryQuerySchema),
    async (req: Request, res: Response) => {
      try {
        const db = getDatabaseService();
  ...
  router.post(
    '/',
    validateRequest(CreateValidationRunRequestSchema),
    async (req: Request, res: Response) => {
      try {
        const db = getDatabaseService();
        const {
  ...
  router.get(
    '/analytics/stages',
    validateQuery(GetStageAnalyticsQuerySchema),
    async (req: Request, res: Response) => {
      try {
        const db = getDatabaseService();
