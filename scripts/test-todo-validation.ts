...
const testTodos = [
  {
    content:
      'Fix success rate calculation showing 5507.2% - implement proper percentage calculation',
    status: 'pending',
    priority: 'high',
    id: '26',
  },
  ...
  {
    content:
      'Mirror vibe-kanban Rust backend functionality - support same agent running and worktree management capabilities',
    status: 'pending',
    priority: 'high',
    id: '48',
  },
  {
    content:
      'Add todo list validation to claude-stop hook - block Claude from stopping if unfinished tasks exist',
    status: 'in_progress',
    priority: 'high',
    id: '49',
  },
