...
describe('validation-utils', () => {
  ...
  describe('validateInput', () => {
    ...
    it('should throw for empty path', () => {
      expect(() => validateInput('', 'path')).toThrow('Invalid path: must be non-empty string');
    });
  ...
  describe('validatePath', () => {
    ...
    it('should throw for empty path', () => {
      expect(() => validatePath('')).toThrow('Invalid path: must be non-empty string');
    });

    it('should throw for non-string path', () => {
      expect(() => validatePath(123 as never)).toThrow('Invalid path: must be non-empty string');
    });
  ...
  describe('validateCommand', () => {
    ...
    it('should throw for empty command', () => {
      expect(() => validateCommand('')).toThrow('Invalid command: must be non-empty string');
    });
  ...
  describe('validatePort', () => {
    ...
    it('should throw for invalid port numbers', () => {
      expect(() => validatePort(0)).toThrow('Invalid port: 0. Must be integer between 1-65535');
