...
import { shouldBlockClaude, createBlockMessage } from './severity-analysis-core';
 ...
 */
export function processStructuredReviewResults(reviewComments: ReviewComments): PrecommitResult {
  // Check for blocking issues in structured data
  const hasBlockingIssues = Object.entries(reviewComments).some(([, comments]) => {
