...
describe('LLMReviewerCore', () => {
  ...
  describe('constructor', () => {
    it('should initialize successfully with valid API key', () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith(
        '✅ LLMReviewerCore initialized with model: gpt-4o-mini'
      );
    ...
    it('should throw error when API key is missing', () => {
      ...
      expect(() => new LLMReviewerCore()).toThrow(
  ...
  describe('reviewCode', () => {
    ...
    it('should handle malformed JSON response gracefully', async () => {
      ...
      expect(consoleSpy).toHaveBeenCalledWith('Review failed for test.ts:', expect.any(Error));
