...
-- CreateIndex
CREATE INDEX "validation_runs_timestamp_idx" ON "validation_runs"("timestamp");

-- CreateIndex
CREATE INDEX "validation_runs_success_idx" ON "validation_runs"("success");

-- CreateIndex
CREATE INDEX "validation_runs_environment_idx" ON "validation_runs"("environment");

-- CreateIndex
CREATE INDEX "validation_runs_timestamp_success_idx" ON "validation_runs"("timestamp", "success");

-- CreateIndex
CREATE INDEX "validation_runs_task_id_idx" ON "validation_runs"("task_id");
